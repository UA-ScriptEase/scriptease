...
public class ImageOp {
	...
	public static BufferedImage mergeImages(Collection<BufferedImage> imagesToMerge){
		BufferedImage image;
		int pixelBuffer = 3;
		int maxWidth = 0;
		int sigmaHeight = 0;
		...
		image = new BufferedImage(maxWidth, sigmaHeight + imagesToMerge.size() * pixelBuffer, BufferedImage.TYPE_INT_ARGB);
