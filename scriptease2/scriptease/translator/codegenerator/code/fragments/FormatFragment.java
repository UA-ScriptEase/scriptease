 ...
 * FormatFragments:
 * <ol>
 * <li>{@link SimpleFragment}s directives indicate that a single special code
 ...
 * @author remiller
 */
public abstract class FormatFragment {
	 ...
	 */
	public FormatFragment(String text) {
		this.directive = text;
	}
	 ...
	 *         context.
	 */
	public static String resolveFormat(Collection<FormatFragment> format,
			Context context) {
		StringBuilder code = new StringBuilder();

		for (FormatFragment token : format) {
	...
	public boolean equals(Object other) {
		if (other instanceof FormatFragment) {
