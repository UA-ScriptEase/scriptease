...
public final class OpenModelAction extends AbstractAction {
	private static final String OPEN_MODEL = Il8nResources
			.getString("Open_Model");

	private static final Action instance = new OpenModelAction();
	...
	public static Action getInstance() {
		return OpenModelAction.instance;
	}
	 ...
	 * mnemonic.
	 */
	private OpenModelAction() {
		super(OpenModelAction.OPEN_MODEL + "...");
